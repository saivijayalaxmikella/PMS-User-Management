...
//    let sectionData = [
//        [("Dashboard", "Go to Dashboard", "dash-Setting")],
//        [
//            ("User", "User Settings", "users"),
//            ("Roles", "Manage Roles", "Roles Data"),
//            ("Permissions", "Manage Permissions", "Permissions Data"),
//            ("Mapping", "Manage Mappings", "Mapping Data")
//        ],
//        [
//            ("Project Roles", "Manage Project Roles", "proles"),
//            ("Project Permissions", "Manage Permissions", "ppermissions"),
//            ("Project Mapping", "Map Projects", "pmapping"),
//            ("Template", "Manage Templates", "templates"),
//            ("Issue Types", "Manage Issues", "issuestype"),
//            ("Work Flow", "Define Work Flow", "workflow"),
//            ("Priorities", "Set Priorities", "priorities"),
//            ("Team", "Manage Teams", "pteams"),
//            ("Project", "Project Overview", "project")
//        ],
//        [
//            ("Profile Settings", "Edit Profile", "dash-Setting"),
//            ("Logout", "Logout of Account", "logout")
//        ]
//    ]
//
...
//
//        if let viewController = storyboard?.instantiateViewController(withIdentifier: "UserViewController") as? UserViewController {
//            viewController.selectedUserText = selectedItem.0
